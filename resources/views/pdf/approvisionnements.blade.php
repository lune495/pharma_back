        ...
        <tr  style="border: none">
            ...
            <td style="border: none; margin-left: 15px">
                <div>
                    ...
                    <p style="text-align:left;line-height:5px">{{ $date_facture_achat       }}</p>
                </div>
            </td>
            <td style="border:none;"></td>
        </tr>
    ...
    <tbody style="border:none">
        @foreach($ligne_approvisionnements as $ligne_approvisionnement)
            <tr style="padding:0px;">
                ...
                <td style="font-size:11px;padding: 2px"> {{$ligne_approvisionnement["pu"]}}</td>
                <td style="font-size:11px;padding: 2px"> {{0}}</td>
                <td style="font-size:11px;padding: 2px">{{\App\Models\Outil::formatPrixToMonetaire($ligne_approvisionnement["quantity_received"]*$ligne_approvisionnement["pu"], false, false)}}</td>
            </tr>
        @endforeach
