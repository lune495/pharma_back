            ...
            <section class="droite" style="text-align: center">
                ...
                ************************
                <div style="margin:7px 0">
                    @if(isset($fournisseur["nom_complet"]))
                    {{$fournisseur["nom_complet"]}}
                    @else
                    Fournisseur de passage
                    @endif
                </div>
                <div style="margin:10px 0">
                </div>
                    ...
                    <tr>
                        ...
                        <td style="width: 20%">Montant </td>
                         ...
                         @foreach($ligne_approvisionnements as $ligne_approvisionnement)
                            <tr>
                                <td style="padding : 15px 0"> {{ $ligne_approvisionnement["produit"]["designation"]}}</span> </td>
                                <td style="padding : 15px 0"> {{ $ligne_approvisionnement["quantity_received"] }}</td>
                                <td style="padding : 15px 0">  {{\App\Models\Outil::formatPrixToMonetaire($ligne_approvisionnement["quantity_received"]*$ligne_approvisionnement["produit"]["pa"], false, false) }} </td>
