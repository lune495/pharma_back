                    ...
                    <!-- <tr>
                        ...
                        @foreach($ligne_bon_retours as $ligne_bon_retour )
                            <tr>
                                ...
                                <td style="padding-left: 15px;">{{$ligne_bon_retour["pu"]? \App\Models\Outil::formatPrixToMonetaire($ligne_bon_retour["pu"], false, false) : ""}}</td>
                                {{$ligne_bon_retour["pu"] ? $montant = $montant + ($ligne_bon_retour["pu"] * $ligne_bon_retour["quantite_retour"]) : ""}}
