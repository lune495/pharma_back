...
// Recompilation
Route::get('/compilation_produit_depot',[DepotController::class,'syncProduitsDepots']);
Route::get('/recom_bon_retour',[BonRetourController::class,'recompilationpulignbr']);
