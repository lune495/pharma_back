...
class ProduitController extends Controller
{
    ...
    {
        //
        $top_produit =  DB::select(DB::raw("select produits.designation, sum(vente_produits.qte * vente_produits.prix_vente) as M ontant from vente_produits inner join produits on vente_produits.produit_id = produits.id group by produits.designation Order by sum(vente_produits.qte * vente_produits.prix_vente) desc limit 5"));
