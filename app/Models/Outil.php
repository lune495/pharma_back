...
class Outil extends Model
{
    ...
    public static $queries = array(
        ...
        "approvisionnements"         => "id,user_id,user{name},montant,qte_total_appro,fournisseur_id,fournisseur{id,nom_complet,telephone,adresse},ligne_approvisionnements{id,produit_id,produit{id,designation,pa,pv,qte,famille_id,famille{id,nom}},quantity_received,created_at,created_at_fr,updated_at,updated_at_fr},created_at_fr",
