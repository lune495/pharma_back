...
class LigneApprovisionnementType extends GraphQLType
{
    ...
    public function fields():array
    {
        ...
        [
            ...
            'approvisionnement_id'                                      => [ 'type' => Type::int(), 'description' => ''],
            'produit_id'                                                => [ 'type' => Type::int(), 'description' => ''],
            'quantity_received'                                         => [ 'type' => Type::int(), 'description' => ''],
            'approvisionnement'                                         => [ 'type' => GraphQL::type('Approvisionnement'), 'description' => ''],
