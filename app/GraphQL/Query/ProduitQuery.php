    ...
    public function resolve($root, $args)
    {
        ...
        return $query->map(function (Produit $item)
        {
            ...
            [
                ...
                'stock_pharma'            => $item->stock_pharma,
                'stock_magasin'           => $item->stock_magasin,
                'stock_initial_pharma'    => $item->stock_initial_pharma,
                'stock_initial_magasin'   => $item->stock_initial_magasin,
